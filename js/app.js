...
const getInputValue = (id) => {
	...
	console.log(`Get input value`, converted, element)
	return converted;
};
...
const updatePrice = (id, value) => {
	...
	console.log('Converted', convertPrice)
	...
	div.innerHTML = `
      <div>
        ...
        <div class="d-flex justify-content-between">
          <h4 class="fw-bold">Category: ${product.category}</h4>
